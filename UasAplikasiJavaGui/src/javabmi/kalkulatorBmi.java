...
public class kalkulatorBmi extends javax.swing.JFrame {
    ...
    private void hitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hitungActionPerformed
        // TODO add your handling code here:
        String Info = "";
        String Nim = String.valueOf(nim.getText()); // input nim pengguna//
        String Nama = String.valueOf(nama.getText()); //input nama pengguna //
        double Tinggi = Double.valueOf(tinggi.getText()); //input tinggi badan pengguna//
        Tinggi = Tinggi / 100;
        double Berat = Double.valueOf(berat.getText()); //input berat badan pengguna//
        ...
        if(bmi < 18.5){
         ...
         keterangan.setText(""+Nama   +Info); //output muncul disertai info//
